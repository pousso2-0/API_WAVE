# Copiez ce code dans un fichier nommé "generate_skills.py"

content = """# Compétences Développeur Fullstack
...
with open('competences.md', 'w', encoding='utf-8') as f:
    f.write(content)

print("Le fichier competences.md a été créé avec succès!")
